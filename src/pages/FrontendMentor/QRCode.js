...
export default function QRCodeRender(){
    return(
        <div className='qr-component grid justify-items-center content-center'>
            <div className="bg-white p-3.5 rounded-2xl w-5/6 justify-items-center max-w-sm" >
                <img id='qrcode' src={require('../../assets/images/frontendmentor/image-qr-code.png')} alt='QR Code for Frontend Mentor' />
